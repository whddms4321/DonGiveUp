...
<head>
    <meta charset="UTF-8">
    <link href="/resources/dahyun/css/sprwrite.css" rel="stylesheet">
    <title>기부후기등록</title>
...
<body>
    ...
    <div class="content">
        <div class="sprwTitle">물품후원 후기 글 등록</div>
        <div class="sprwpage">
            <div class="inputTable">
                <form id="#sprwriteFrm" method="post">
                    <table class="sprwTable">
                        <tr>
                            <td class="ipName">제목</td>
                            <td class="ipFrame" colspan="3">
                                <input id="spr_title" type="text">
                            </td>
                        </tr>
                        <tr>
                            <td class="ipName">작성자</td>
                            <td class="ipFrame" colspan="3">
                                <input id="spr_writer" type="text">
                            </td>
                        </tr>
                        <tr>
                            <td class="ipName">후원게시번호</td>
                            <td class="ipFrame">
                                <input id="sp_no" type="text">
                            </td>
                            <td class="ipName">대표이미지</td>
                            <td class="ipImg">
                                <input id="spr_frontimg" type="text">
                        ...
                        <tr>
                            ...
                            <td colspan="3" class="ipFiles">
                                <input id="sprimg_files" type="text" readonly>
