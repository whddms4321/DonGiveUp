	...
	<div class="loginDiv">
		...
		<a href="/member/findPwFrm.don" class="findA">비밀번호 찾기</a>
			...
			<div class="findIdMemberArea">
				<form action="/member/findPwMember.don" method="post" id="findIdMember">
					<table style="text-align: center; margin: 0 auto;">
						<tr>
							<th style="width: 80px; padding-left: 10px; height: 50px;">아이디</th>
							<td style="width: 360px; height: 32px;"><input type="text" name="memberId" placeholder="가입시 입력한 아이디를 입력하세요" style="width: 340px; height: 30px;" required></td>
						</tr>
						<tr>
						...
						<tr>
							<td colspan="2" style="height: 100px;"><button type="submit" class="loginBtn">비밀번호 찾기</button></td>
						</tr>
			...
			<div class="findIdCompanyArea" style="display: none;">
				<form action="/member/findPwCompany.don" method="post">
					<table style="text-align: center; margin: 0 auto;">
						<tr>
							<th style="width: 80px; padding-left: 10px; height: 50px;">아이디</th>
							<td style="width: 360px; height: 32px;"><input type="text" name="memberId" placeholder="가입시 입력한 아이디를 입력하세요" style="width: 340px; height: 30px;" required></td>
