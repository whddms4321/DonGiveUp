...
<body>
	...
	<div class="content">
		<div class="boardTab">
			<div style="width: 100%; height: 120px; background-color: #0fbcff; color: white; line-height: 120px; text-align: center; font-size: 30px; margin-top: 20px; font-weight: bold;">참 여</div>
