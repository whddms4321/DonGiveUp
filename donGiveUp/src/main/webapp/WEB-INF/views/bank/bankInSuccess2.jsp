...
<h1 class="review_h1">기부 완료</h1><br>
         ...
         <table class="table table-bordered">
            ...
            <tr>
               <th>결제 콩</th>
               <td><input type="text"  id="inputArea" class="form-control" name="memberMoney" value="${b.bankInMoney }" readonly></td>
            </tr>
            <tr>
               <th>결제 날짜</th>
             ...
             <tr>
               <th>출금 날짜</th>
               <td><input type="text"  class="form-control" name="regularInPayNum" value="${b.bankInPayNum }" readonly></td>
            </tr>
