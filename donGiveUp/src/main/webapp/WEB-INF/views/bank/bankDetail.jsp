...
<body>
	...
	<div class="content">
		<div class="content-main">
			...
			<div class="content-main2-div1 content-main2-div3"><button class="content-main2-div1-button" onclick="bankMoney('${detail.bankNo}','${detail.bankOrganization }','${detail.bankNowMoney}')" type="button">모금함 기부 하기</button></div>
			</form>
			
			</div>
			<div class="content-main2-div2"><a>저금액의 <b style="color: #0fbcff">73%</b>가 기부되었습니다.</a></div>
		</div><br>
	...
	function bankMoney(bankNo,bankOrganization,bankNowMoney) {
		...
		var title = "bankMoney";
		var status = "left=500px, top=100px, width=550px, height=600px, menubar=no, status=no, scrollbars=yes";
